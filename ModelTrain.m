function [whi, woh] = ModelTrain(savePath_1)
%train model.. savePath_1 should be: '/Users/Davis/Desktop/Model/params/params1.mat'
data = load(savePath_1);

trainData = data.input_train;
trainLabels = data.label_gabor_train;

testData = data.input_test;
testLabels = data.label_gabor_test;

validData = data.input_valid;
validLabels = data.label_gabor_valid;
